/** first version of recursive dynamic programming image compression 
  * with iterative traceback method */

package applications;

import utilities.*;

public class RecursiveDPImageCompression3
{
   ...
   {
      RecursiveDPImageCompression3.l = l;
      RecursiveDPImageCompression3.b = b;
      RecursiveDPImageCompression3.kay = kay;
      return s(l.length - 1);
   }
